...
public class SportsFragment extends Fragment {
    ...
    private List<News>            sportsList            = new ArrayList<News>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        contentView = inflater.inflate(R.layout.frag_sports, null);

        contentLayout = (LinearLayout) contentView.findViewById(R.id.ll_sports_container);
    ...
    private void initListView() {
        ...
        pullToRefreshListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Uri uri = Uri.parse(sportsList.get(position - 1).url);
                intent.setData(uri);
    ...
    private void initData(List<News> data) {
        ...
        if (newsApdapter == null) {
            newsApdapter = new NewsApdapter(getActivity(), sportsList);
    ...
    private class GetData extends AsyncTask<String, Integer, List<News>> {
        ...
        protected synchronized List<News> doInBackground(String... params) {
            result = HttpUtils.getHttpRequest(Constants.URL_SPORTS + pageNum);// http://apis.baidu.com/txapi/world/world?num=10&page=1
            try {
