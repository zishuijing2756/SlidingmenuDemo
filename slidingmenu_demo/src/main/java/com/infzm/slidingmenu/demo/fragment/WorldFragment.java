...
public class WorldFragment extends Fragment {
    ...
    private List<News>            worldList             = new ArrayList<News>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        contentView = inflater.inflate(R.layout.frag_world, null);

        contentLayout = (LinearLayout) contentView.findViewById(R.id.ll_world_container);
        // contentSwipeLayout.setOnRefreshListener(this);
        // // 顶部刷新的样式
        // contentSwipeLayout.setColorSchemeResources(R.color.blue, R.color.green,
    ...
    private void initListView() {
        ...
        pullToRefreshListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Uri uri = Uri.parse(worldList.get(position - 1).url);
                intent.setData(uri);
    ...
    private void initData(List<News> data) {
        ...
        if (newsApdapter == null) {
            newsApdapter = new NewsApdapter(getActivity(), worldList);
    ...
    private class GetData extends AsyncTask<String, Integer, List<News>> {
        ...
        protected synchronized List<News> doInBackground(String... params) {
            result = HttpUtils.getHttpRequest(Constants.URL_WORLD + pageNum);// http://apis.baidu.com/txapi/world/world?num=10&page=1
            try {
