 ...
 * License.
 *******************************************************************************/
package com.handmark.pulltorefresh.library.swipListView;
...
import com.handmark.pulltorefresh.library.swipListView.internal.FlipLoadingLayout;
import com.handmark.pulltorefresh.library.swipListView.internal.LoadingLayout;
import com.handmark.pulltorefresh.library.swipListView.internal.LoadingLayoutProxy;
import com.handmark.pulltorefresh.library.swipListView.internal.RotateLoadingLayout;
import com.handmark.pulltorefresh.library.widget.SwipeListView;

public abstract class PullToRefreshBaseSwipeListView<T extends SwipeListView> extends LinearLayout implements IPullToRefreshSwipeListView<T> {
    ...
    public PullToRefreshBaseSwipeListView(Context context){
        super(context);
        init(context, null);
    }

    public PullToRefreshBaseSwipeListView(Context context, AttributeSet attrs){
        super(context, attrs);
        init(context, attrs);
    }

    public PullToRefreshBaseSwipeListView(Context context, Mode mode){
        super(context);
        mMode = mode;
        init(context, null);
    }

    public PullToRefreshBaseSwipeListView(Context context, Mode mode, AnimationStyle animStyle){
        super(context);
        mMode = mode;
     ...
     * @author Chris Banes
     */
    public static interface OnPullEventListener<V extends SwipeListView> {
         ...
         */
        public void onPullEvent(final PullToRefreshBaseSwipeListView<V> refreshView, State state, Mode direction);
     ...
     * @author Chris Banes
     */
    public static interface OnRefreshListener<V extends SwipeListView> {

        /**
         * onRefresh will be called for both a Pull from start, and Pull from end
         */
        public void onRefresh(final PullToRefreshBaseSwipeListView<V> refreshView);
     ...
     * @author Chris Banes
     */
    public static interface OnRefreshListener2<V extends SwipeListView> {
         ...
         */
        public void onPullDownToRefresh(final PullToRefreshBaseSwipeListView<V> refreshView);

        /**
         * onPullUpToRefresh will be called only when the user has Pulled from the end, and released.
         */
        public void onPullUpToRefresh(final PullToRefreshBaseSwipeListView<V> refreshView);
    ...
    final class SmoothScrollRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (mContinueRunning && mScrollToY != mCurrentY) {
                ViewCompat.postOnAnimation(PullToRefreshBaseSwipeListView.this, this);
            } else {
                if (null != mListener) {
