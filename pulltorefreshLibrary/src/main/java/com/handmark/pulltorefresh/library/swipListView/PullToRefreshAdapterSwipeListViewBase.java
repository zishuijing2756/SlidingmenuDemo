...
import com.handmark.pulltorefresh.library.swipListView.internal.IndicatorLayout;
import com.handmark.pulltorefresh.library.widget.SwipeListView;

public abstract class PullToRefreshAdapterSwipeListViewBase<T extends SwipeListView> extends PullToRefreshBaseSwipeListView<T> implements OnScrollListener {
    ...
    public PullToRefreshAdapterSwipeListViewBase(Context context){
        super(context);
        mRefreshableView.setOnScrollListener(this);
    }

    public PullToRefreshAdapterSwipeListViewBase(Context context, AttributeSet attrs){
        super(context, attrs);
        mRefreshableView.setOnScrollListener(this);
    }

    public PullToRefreshAdapterSwipeListViewBase(Context context, Mode mode){
        super(context, mode);
        mRefreshableView.setOnScrollListener(this);
    }

    public PullToRefreshAdapterSwipeListViewBase(Context context, Mode mode, AnimationStyle animStyle){
